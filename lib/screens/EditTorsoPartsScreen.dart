...
class EditTorsoPartsScreen extends StatefulWidget {
  static const routeName = '/edit-torso-parts';
  ...
  const EditTorsoPartsScreen(
      {Key? key,
      required this.torsoServices,
  ...
  @override
  State<EditTorsoPartsScreen> createState() => _EditTorsoPartsScreenState();
}

class _EditTorsoPartsScreenState extends State<EditTorsoPartsScreen> {
  XFile? _imagefile;
  String? imageURL;
