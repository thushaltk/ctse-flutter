...
class EditHandPartsScreen extends StatefulWidget {
  static const routeName = '/edit-hand-parts';
  final HandsServices handServices;
  final String id;
  ...
  const EditHandPartsScreen(
      {Key? key,
      required this.handServices,
  ...
  @override
  State<EditHandPartsScreen> createState() => _EditHandPartsScreenState();
}

class _EditHandPartsScreenState extends State<EditHandPartsScreen> {
  XFile? _imagefile;
  String? imageURL;
