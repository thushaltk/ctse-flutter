...
class AddTorsoPartsScreen extends StatefulWidget {
  static const routeName = '/add-torso-parts';
  final TorsoServices torsoServices;

  const AddTorsoPartsScreen({Key? key, required this.torsoServices}) : super(key: key);

  @override
  State<AddTorsoPartsScreen> createState() => _AddTorsoPartsScreenState();
}

class _AddTorsoPartsScreenState extends State<AddTorsoPartsScreen> {
  XFile? _imagefile;
  String? imageURL;
