...
class EditHeadPartsScreen extends StatefulWidget {
  static const routeName = '/edit-head-parts';
  final HeadServices headServices;
  final String id;
  ...
  const EditHeadPartsScreen(
      {Key? key,
      required this.headServices,
  ...
  @override
  State<EditHeadPartsScreen> createState() => _EditHeadPartsScreenState();
}

class _EditHeadPartsScreenState extends State<EditHeadPartsScreen> {
  XFile? _imagefile;
  String? imageURL;
